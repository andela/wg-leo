...
class ExercisesEditAddView(WgerFormMixin):
    ...
    def get_form_class(self):
        ...
        # during the request
        # have we access to the currently used language. In other places
        # Django defaults
        # to 'en-us'.
...
class ExerciseCorrectView(ExercisesEditAddView, LoginRequiredMixin,
    ...
    messages = _(
        'Thank you. Once the changes are reviewed the'
        'exercise will be updated.'
    )
    ...
    def form_valid(self, form):
        '''
        If the form is valid send email notifications to
