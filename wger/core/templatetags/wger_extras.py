...
def get_current_settings(exercise, set_id):
    ...
    arguments to function in the template, and we are only interested
    on the settings that belong to the current set
    '''
...
def pagination(paginator, page):
    ...
    # we muck around here to remove the
    # pages not inmediately 'around' the current
