...
entries, but can be somewhat overwhelming and make the search difficult.'''),
        default=True)
...
class DaysOfWeek(models.Model):
    '''
    Model for the days of the week. This model

    is needed so that 'Day' can have multiple days of the week selected
    '''
